...
class StudentController extends Controller
{
    ...
    public function students()
    {
        ...
        return view('accueil',['students'=>$students]);
    }

    public function coursesByStudentId($id)
    {
        $courses = Student::coursesByStudentId($id);
